"""create_table_kauppalehti_XHEL_prices

Revision ID: 5db852c27129
Revises: 326aa287f7e9
Create Date: 2019-01-01 21:19:56.839381
...
revision = '5db852c27129'
down_revision = '326aa287f7e9'
branch_labels = None
depends_on = None
...
def upgrade():
        ...
        connection.execute("""
                            CREATE TABLE kauppalehti.xhel_prices (
...
def downgrade():
        connection = op.get_bind()
        connection.execute("""
                            DROP table kauppalehti.xhel_prices
                            """)