"""create_table_stage_kauppalehti_xsto_prices

Revision ID: ef3917e35416
Revises: 5db852c27129
Create Date: 2019-01-03 22:05:53.087171
...
revision = 'ef3917e35416'
down_revision = '5db852c27129'
branch_labels = None
depends_on = None
...
def upgrade():
        ...
        connection.execute("""
                            CREATE TABLE stage.kauppalehti_xsto_prices (
...
def downgrade():
        connection = op.get_bind()
        connection.execute("""
                            DROP table stage.kauppalehti_xsto_prices
                            """)
